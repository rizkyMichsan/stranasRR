...
<div class="modal fade" id='Ic_users_form'  role="dialog">
        ...
        <form action='' method="post" id="users_form" ><div class="form-group form-float">
            <div class="form-line">
        ...
        </div><div class="form-group form-float" id="form-password">
            <div class="form-line">
    ...
    <form action='' method="post" id="ttd_form" enctype="multipart/form-data"><div class="form-group form-float">
