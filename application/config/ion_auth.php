...
*/
$config['tables']['users']           = 'ic_users';
$config['tables']['groups']          = 'ic_groups';
$config['tables']['users_groups']    = 'ic_users_groups';
$config['tables']['login_attempts']  = 'ic_login_attempts';
 ...
 */
$config['site_title']                 = "Stranas RR";       // Site Title, example.com
$config['admin_email']                = "rizkymaulanaichsan@gmail.com"; // Admin Email, admin@example.com
