...
<head>
    ...
    <title><?php $in   =   $this->Mmenu->where_row('config', array('code' => 'system_title'));
            echo $in->name; ?></title>
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url(); ?>assets/images/<?php $in   =   $this->Mmenu->where_row('config', array('code' => 'icon'));
                                                                    echo $in->name; ?>" type="image/x-icon">
    ...
    <!-- assets Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo base_url(); ?>assets/css/themes/all-themes.css" rel="stylesheet" />
    <link href="<?php echo base_url() ?>assets/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
</head>

<body class="theme-<?php $in   =   $this->Mmenu->where_row('config', array('code' => 'theme'));
                    echo $in->name; ?>">
    <!-- Page Loader -->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>"><?php $in   =   $this->Mmenu->where_row('config', array('code' => 'system_title'));
                                                                            echo $in->name; ?></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    ...
                    if ($user->image == 'users.png') {
                        echo '<img src="' . base_url() . 'assets/images/' . $user->image . '" width="48" height="48" alt="User" />';
                    } else {
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; <?php $in   =   $this->Mmenu->where_row('config', array('code' => 'copyright'));
                            echo $in->name; ?> <a href="javascript:void(0);"><?php $in   =   $this->Mmenu->where_row('config', array('code' => 'system_title'));
                                                                                echo $in->name; ?></a>.
                </div>
                <div class="version">
                    <b>Version: </b> <?php $in   =   $this->Mmenu->where_row('config', array('code' => 'version'));
                                        echo $in->name; ?>
                </div>
            </div>
            <!-- #Footer -->
